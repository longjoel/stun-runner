"""Public ROM-free tests for the Agent 2 C port of the score slice.

Compiles reproduction/maincpu/score.c with the system C compiler
and runs its self-check (award selection, weapon_probe golden run,
hit counter). No ROMs, no MAME, no network required.
"""
import pathlib
import shutil
import subprocess
