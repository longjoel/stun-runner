...
| `0xFF9578–0xFF9579` | separate state/index word read by the object-award path at `0x03A2B2`, `0x03A2DA`, and `0x03A2F8`; recorded human play observed `0→1→2→3→4→5`, with all five normal nonzero writes attributed to `0x0320BC` | `DYNAMIC-WRITER-CONFIRMED; DISPLAYED TRACK LABEL UNPROVEN` |
