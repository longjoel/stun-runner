...
| `0xFFDCC6–0xFFDCC7` | 16-bit trajectory coordinate/state field; `0x0387C6`, `0x038D94`, and `0x038DF0` initialize it, `0x0388DE–0x038942` integrate and clamp it using the motion delta at `0xFFDD16`, and the effect/object builders consume it through the trajectory record at `0xFFDAF0`; physical axis and effect identity remain unresolved | `STATIC-RESOLVED-TRAJECTORY; NOT-AMMO` |
