...
| `0xFFDE8A–0xFFDE94` | six 16-bit event-slot counters; `0x0416D8` reloads a slot from ROM table `0x4EF20`, `0x041644` decrements it, and zero invokes the event/effect path at `0x041606` | `STATIC + EVENT-TRACE; SHIELD-CANDIDATE; NOT-CONFIRMED` |
