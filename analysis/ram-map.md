...
| `0xFFDD85–0xFFDD90` | persistent fork-lateral-dependent object/renderer record fields; values diverge from the no-input fork after relative frame 300, but no player-status ownership is established | `SAVE-STATE-DIFFERENTIAL; SEMANTIC-OWNERSHIP-UNRESOLVED` |
