...
| `0xFFDCC0–0xFFDCE0` | transient trajectory/animation state; writers `0x0388DE–0x038A14` update a coherent 17-pass position/velocity-like record only after the paired Button 1 → Button 2 sequence; isolated buttons produce one-shot initialization writes | `STATIC + WRITER-TRACE + PAIRED-INPUT-DIFFERENTIAL` |
