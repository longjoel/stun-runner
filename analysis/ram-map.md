...
| `0xFF9578–0xFF9579` | separate state/index word read by the object-award path at `0x03A2B2`, `0x03A2DA`, and `0x03A2F8`; executable writers select ROM-driven and explicit progression values, but current runs leave it zero | `STATIC-STRONG-CANDIDATE; NONZERO TRANSITION UNREPRODUCED` |
